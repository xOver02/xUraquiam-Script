												...
												pcall(function()
													if game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
														...
														if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 350 then
															...
															game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0, 4, 10)
                                                            wait(1)
	...
	local Main = library:Window("xDeility","Blox Fruits")
...
--------------------------------------------------------------------------------------------------------------------
    ...
    PlayerEspTab:Toggle("Auto Bounty",false,function(d)
        AutoBounty = d
    end)
	...
	spawn(function()
		game:GetService("RunService").Heartbeat:connect(function()
			pcall(function()
				if AutoBounty == true or _G.HopServerOn == true then
	...
	spawn(function()
		while wait() do
			pcall(function()
				if AutoBounty and killandhopsize then
		...
		while wait() do
			pcall(function()
				...
				elseif _G.HopServerOn == true then
					...
					until AutoBounty == false or _G.HopServerOn == false
				end
			end)
		end
	end)
	
	PlayerEspTab:Toggle("Auto Bounty + Hop",getgenv().Setting["Bounty Hop"],function(bool)
		BountyHop = bool
	end)
...
PlayerEspTab:Line()
	...
	RaidsTab:Button("TP Dungeon",function()
		if NewWorld then
	...
	RaidsTab:Button("TP Awakening Room",function()
		if NewWorld then
			if StatsBypassTP == "Bypassed" and UseTP then
    ...
    MiscTab:Line()
    MiscTab:Label("Discord")

    MiscTab:Button("Copy LinkDiscord : xUraquiamHub",function()
        setclipboard("https://discord.gg/35cN4f5zhN")
    end)

    MiscTab:Line()
    MiscTab:Label("Server")
    ...
    MiscTab:Button("Beautiful Mode", function()
        BeautifulMode()
    end)
...
if _G.BeautifulMode then
    ...
    MiscTab:Toggle("Infinits Agility",false,function(value)
        InfAbility = value
    end)
...
function InfAb()
	...
	MiscTab:Toggle("Infinits Ken",false,function(Value)
	...
	MiscTab:Toggle("Water On Walk",waterwalk,function(value)
		WaterWalk = value
	end)
	spawn(function()
		while wait() do
    ...
    local AutoFarmTabSetting = Main:Tab("Setting")

	AutoFarmTabSetting:Line()

	AutoFarmTabSetting:DestroyGui()

	AutoFarmTabSetting:Line()

	AutoFarmTabSetting:Toggle("Skill Z", true,function(a)
		SkillZ = a
	end)
	AutoFarmTabSetting:Toggle("Skill X", true,function(a)
		SkillX = a
	end)
	AutoFarmTabSetting:Toggle("Skill C", true,function(a)
		SkillC = a
	end)
	AutoFarmTabSetting:Toggle("Skill V", true,function(a)
		SkillV = a
	end)
	...
	AUTOHAKI = true
	AutoFarmTabSetting:Toggle("Auto Haki", AUTOHAKI,function(Value)
		AUTOHAKI = Value  
	end)
	AutoFarmTabSetting:Toggle("Auto Ken Haki", false,function(Value)
		AUTOHAKIObs = Value  
	end)
	AutoRejoin = _G.AutoRejoin or false
	AutoFarmTabSetting:Toggle("Auto Rejoin", getgenv().Setting["Auto Rejoin"],function(a)
		AutoRejoin = a
	end)

    AutoFarmTabSetting:Line()

    AutoFarmTabSetting:Toggle("DeleteAttackFx",false,function(vu)
        _G.DeleteAttackFx = vu
    end)

    AutoFarmTabSetting:Toggle("Hidden Mon",false,function()
	...
	AutoFarmTabSetting:Toggle("Anit AFK", true,function(vu)
		game:GetService("Players").LocalPlayer.Idled:connect(function()
			vu:Button2Down(Vector2.new(0,0),workspace.CurrentCamera.CFrame)
			wait(1)
			vu:Button2Up(Vector2.new(0,0),workspace.CurrentCamera.CFrame)
    ...
    AutoFarmTabSetting:Line()
    AutoFarmTabSettng:Label("Crack Another")

    AutoFarmTabSetting:Button("Chicken Hub",function(d)
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ErenYeaker/Chicken-Hub/main/Test-Ver.lua"))();
    end)

    AutoFarmTabSetting:Button("Gunna Hub",function(d)
        loadstring(game:HttpGet("https://raw.githubusercontent.com/projectgunnaz/Loader-Guuna/main/message%252520(15)-obfuscated.lua"))();
    end)
